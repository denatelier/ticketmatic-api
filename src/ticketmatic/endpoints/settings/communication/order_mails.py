...
def get_list(client: Client, params: OrderMailTemplateQuery | dict | None = None) -> OrderMailsList:
    return crud_get_list(client, _URL, OrderMailTemplateQuery, params, OrderMailsList, _FIELDS)
...
def update(client: Client, id: int, data: OrderMailTemplate | dict) -> OrderMailTemplate:
