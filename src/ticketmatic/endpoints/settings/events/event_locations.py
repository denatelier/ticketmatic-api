...
def get_list(client: Client, params: EventLocationQuery | dict | None = None) -> EventLocationsList:
    return crud_get_list(client, _URL, EventLocationQuery, params, EventLocationsList, _FIELDS)
