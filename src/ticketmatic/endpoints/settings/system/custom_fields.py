...
from ticketmatic.models.settings import CustomField, CustomFieldQuery, CustomFieldValue, CustomFieldValueQuery
...
def get_list(client: Client, params=None) -> CustomFieldsList:
    return crud_get_list(client, _URL, CustomFieldQuery, params, CustomFieldsList, _FIELDS)
...
def values_get_list(client: Client, params=None) -> CustomFieldValuesList:
    return crud_get_list(client, _VAL_URL, CustomFieldValueQuery, params, CustomFieldValuesList, _FIELDS)
