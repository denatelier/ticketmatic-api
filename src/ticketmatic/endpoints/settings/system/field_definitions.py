...
from ticketmatic.models.settings import FieldDefinition, FieldDefinitionQuery, FielddefinitionsDataRequest, FielddefinitionsDataResult
...
def get_list(client: Client, params=None) -> FieldDefinitionsList:
    return crud_get_list(client, _URL, FieldDefinitionQuery, params, FieldDefinitionsList, _FIELDS)
...
def get_data(client: Client, data: FielddefinitionsDataRequest | dict) -> list[FielddefinitionsDataResult]:
