...
from ticketmatic.models.ticket import Ticketsalesflow, TicketsalesflowQuery, Ticketsalessetup, TicketsalessetupQuery
...
def get_list(client: Client, params=None) -> TicketsalesflowsList:
    return crud_get_list(client, _URL, TicketsalesflowQuery, params, TicketsalesflowsList, _FIELDS)
...
def setups_get_list(client: Client, params=None) -> TicketsalessetupsList:
    return crud_get_list(client, _SETUP_URL, TicketsalessetupQuery, params, TicketsalessetupsList, _FIELDS)
